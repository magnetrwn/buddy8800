...
Contributor and coding-agent guidance is maintained in [AGENTS.md](AGENTS.md).
It describes the repository architecture, behavioral contracts, validation
requirements, and links to the project style and refactoring plans.
